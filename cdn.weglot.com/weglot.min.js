var Weglot = function() {
    ...
    Ce.set = function(e, t, n, r, o) {
        Se && (e = e.replace(/[^+#$&^`|]/g, encodeURIComponent).replace("(", "%28").replace(")", "%29"), t = t.toString().replace(/[^+#$&/:<-[\]-}]/g, encodeURIComponent), !n && gt.is_connect && gt.subdomain && (n = gt.host.split("www.").pop()), n = n ? ";domain=" + n : "", o = o ? ";expires=" + o : "", r = r || "", document.cookie = e + "=" + t + n + ";path=/" + r + o + ";SameSite=None;Secure")
    }, Ce.get = function(e) {
        if (!Se) return null;
    ...
    xe(gt && Object.keys(gt).length > 0, "onOptionsReady", (function() {
        if (gt.dynamicPushState) {
            ...
            history.pushState = function() {
                ...
                e.apply(history, t);
                var r = Te();
                je.hostname = r.hostname, je.pathname = r.pathname, je.url = r.url, Le("onCurrentLocationChanged")
            }
        }
    }));
    var Ae, Pe = {};
    ...
    function Fe() {
        return new Promise((function(e) {
            for (var t = gt.languages, n = {}, r = function() {
                    var r = a[o],
                        i = r.custom_code,
                        s = r.language_to;
                    (function(e) {
    ...
    function $e(e) {
        ...
        if (t && t.slugTranslation) {
            ...
            Be.version < n && (Be.network ? Be.network.resolved || Be.network.then((function(t) {
                return e(Ve(t))
            })) : Be.network = Fe().then((function(t) {
                return Be.network.resolved = !0,
                    function(e) {
                        var t = gt.versions,
                            n = {
    ...
    function Ye(e, t) {
        gt.is_tld && gt.auto_switch && (e === gt.language_from ? t.searchParams.set("no_redirect", "true") : t.searchParams.delete("no_redirect"))
    }
    ...
    function Ke(e, t) {
        ...
        return o && (r.hostname = o), r.pathname = function(e, t, n, r) {
            ...
            return r === gt.language_from ? Ge.originalPath : e[r] && e[r].original ? Je(Ge.originalPath, e[r].original) : t
        }(t, r.pathname, n, e), gt.subdirectory && e && (r.pathname = function(e, t) {
    ...
    function tt(e, t) {
        return gt.is_connect && e !== gt.language_from ? Ze[t] ? Ze[t] : ($e((function(r) {
    ...
    Ne("onCurrentLocationChanged", (function() {
        ...
        !1 !== gt.original_shopify_checkout && gt.is_connect && !gt.subdirectory && gt.language_from === Ue() && et()
    }));
    var nt = {};
    ...
    nt[$] = function() {
        var e = function(e) {
                ...
                for (var t = function(t) {
                    ...
                    0 === s.indexOf(t("/cart")) && s.split("?")[0] !== t("/cart") || i.setAttribute("action", ve(s, "locale", r))
                }
            ...
            t = function(e) {
                void 0 === e && (e = Ue());
                var t = document.getElementById("create_customer") || document.querySelector('form[action="' + tt(e, "/account") + '"]') || "string" == typeof gt.customer_tag && le(document, gt.customer_tag);
                if (t) {
        ...
        var r = function() {
            ...
            o = function(e) {
                if (void 0 === e && (e = Ue()), !gt.visual_editor && window.top === window.self) {
                    var t = gt.cart_attributes.map((function(t) {
                    ...
                    !1 !== gt.original_shopify_checkout && gt.is_connect && !gt.subdirectory && gt.language_from === Ue() && r.then((function(e) {
                        return e.json()
                    })).then((function(e) {
                        var t = e.token;
        ...
        function a(a) {
            if (gt.language_from !== a) {
                var i, s;
                window.Shopify && (window.Shopify.locale = a), !he() && gt.order_tag && o(a), e(a), i = a, (s = r()) && Ce.set("checkout_locale", n(i), null, s);
        ...
        Ne("initialized", (function() {
            window.langify && W.log("%c Please, uninstall langify to properly use Weglot", {
                sendToDatadog: !1
            }), he() || !gt.order_tag || gt.is_connect && gt.language_from !== Ue() || o(), e();
            var r, a = document.querySelectorAll("[data-wg-only-display]");
            a.length && Me(a), gt.customer_tag && t(), document.getElementsByClassName("shopify-payment-button").length && (r = window.fetch, window.fetch = function() {
                if ("/wallets/checkouts.json" === arguments[0]) try {
                    var e = JSON.parse(arguments[1].body),
                        t = n(Ue());
                    e.checkout.attributes = {}, gt.cart_attributes.forEach((function(n) {
            ...
            return fe("admin-bar-iframe") || fe("preview-bar-iframe") || gt.private_mode || function() {
        ...
        if (window.wixBiSession && "bolt" !== window.wixBiSession.renderType && !gt.visual_editor && (document.addEventListener("DOMContentLoaded", (function() {
                new MutationObserver((function(e) {
                    for (var t = 0; t < e.length; t++) {
                        "SUCCESS" === e[t].target.getAttribute("data-santa-render-status") && (this.disconnect(), Le("start"))
                    }
    ...
    function ut(e) {
        ...
        return function(e) {
            ...
            if (a) return fetch("" + U + a + ".json").then((function(e) {
                return e.json()
            })).then((function(e) {
                ...
                }))), e.is_dns_set = !0, e.previewHash = a, e
            }));
    ...
    function dt(e) {
        ...
        e.injectedData || ("loading" === document.readyState ? document.addEventListener("DOMContentLoaded", (function() {
            ...
            var e = document.getElementById("admin-bar-iframe") || document.getElementById("preview-bar-iframe") || -1 !== location.search.indexOf("weglot-private=1") || "1" === ze({
                type: "cookie"
    ...
    function kt(e) {
        ...
        var r = e || vt(Ue());
        return void 0 !== yt[r] && yt.currentLang === r || (yt.currentLang = r, gt.injectedData && gt.injectedData.originalPath && (n = gt.injectedData.originalPath.toLowerCase()), t.some((function(e) {
            var t = e.type,
                o = e.value,
    ...
    function Et() {
        if (wt) return wt;
        if (!gt.api_key) return W.warn("Weglot must be initialized to use it.", {
            sendToDatadog: !1
        }), [];
        var e = (gt.languages || []).filter((function(e) {
                var t = kt(e.language_to),
                    n = !t || t.language_button_displayed;
                return (!1 !== e.enabled || gt.private_mode) && n && (gt.subdirectory || !gt.is_connect || e.connect_host_destination && e.connect_host_destination.created_on_aws)
            })).map((function(e) {
                return e.custom_code || e.language_to
            })),
            t = [gt.language_from].concat(e);
        return wt = t.filter((function(e, n) {
    ...
    var Ot = function() {
        ...
        if (!(!gt.auto_switch || gt.subdirectory || e || ze({
                type: "cookie"
            }).getItem("WG_CHOOSE_ORIGINAL") || he() || gt.visual_editor)) {
            var t = Ct();
            return t && !kt(t) ? t : gt.auto_switch_fallback && !kt(gt.auto_switch_fallback) ? gt.auto_switch_fallback : void 0
        }
        e && xt(Ue())
    };
    ...
    if (It.getItem(F)) try {
        Dt = JSON.parse(It.getItem(F)), Object.keys(Dt).forEach((function(e) {
    ...
    function Ut(e, t, n, r) {
        var o, a = Wt(e);
        a ? (a[r] = n, a.createdTime = (new Date).getTime(), a.t = t) : Dt[e] = ((o = {})[r] = n, o.createdTime = (new Date).getTime(), o.t = t, o), Rt[r] || (Rt[r] = {}), Rt[r][n] = e, gt.cache && we(Mt)()
    }
    var Mt = function() {
    ...
    function Bt(e) {
        for (var t = [], n = 0, r = e; n < r.length; n += 1) {
            var o = r[n]; - 1 === qt.indexOf(o) && t.push(o)
        }
    ...
    function $t(e, t) {
        ...
        return i.length ? (e.words = i, e.request_url = function() {
            ...
            var t = gt.versions && gt.versions.translation || 1,
                ...
                r = "https://" + (gt.bypass_cdn_api ? "api.weglot.com" : "cdn-api-weglot.com") + "/translate?" + n.join("&");
            return fetch(r, {
                method: "POST",
                body: Gt(JSON.stringify(e))
            }).then(Jt).then((function(e) {
                return e.json()
            })).then((function(e) {
    ...
    function Kt(e, t) {
        ...
        var n = Ue();
        return n === gt.language_from ? (t(e), !1) : ($t({
            l_from: n,
    ...
    function mn(e) {
        (!e.__d && (e.__d = !0) && tn.push(e) && !vn.__r++ || nn !== Qt.debounceRendering) && ((nn = Qt.debounceRendering) || rn)(vn)
    }

    function vn() {
        var e, t, n, r, o, a, i, s;
        for (tn.sort(on); e = tn.shift();) e.__d && (t = tn.length, r = void 0, o = void 0, i = (a = (n = e).__v).__e, (s = n.__P) && (r = [], (o = ln({}, a)).__v = a.__v + 1, Nn(s, a, o, n.__n, void 0 !== s.ownerSVGElement, null != a.__h ? [i] : null, r, null == i ? pn(a) : i, a.__h), Ln(r, a), a.__e != i && hn(a)), tn.length > t && tn.sort(on));
        vn.__r = 0
    }

    function wn(e, t, n, r, o, a, i, s, c, l) {
        var u, f, d, g, _, p, h, m = r && r.__k || sn,
            v = m.length;
        for (n.__k = [], u = 0; u < t.length; u++)
            if (null != (g = n.__k[u] = null == (g = t[u]) || "boolean" == typeof g || "function" == typeof g ? null : "string" == typeof g || "number" == typeof g || "bigint" == typeof g ? dn(null, g, null, null, g) : Array.isArray(g) ? dn(gn, {
                    children: g
                }, null, null, null) : g.__b > 0 ? dn(g.type, g.props, g.key, g.ref ? g.ref : null, g.__v) : g)) {
                ...
                Nn(e, g, d = d || an, o, a, i, s, c, l), _ = g.__e, (f = g.ref) && d.ref != f && (h || (h = []), d.ref && h.push(d.ref, null, g), h.push(f, g.__c || _, g)), null != _ ? (null == p && (p = _), "function" == typeof g.type && g.__k === d.__k ? g.__d = c = yn(g, c, e) : c = kn(e, g, d, m, _, c), "function" == typeof n.type && (n.__d = c)) : c && d.__e == c && c.parentNode != e && (c = pn(d))
            }
        for (n.__e = p, u = v; u--;) null != m[u] && ("function" == typeof n.type && null != m[u].__e && m[u].__e == n.__d && (n.__d = En(r).nextSibling), An(m[u], m[u]));
        if (h)
            for (u = 0; u < h.length; u++) jn(h[u], h[++u], h[++u])
    }

    function yn(e, t, n) {
        for (var r, o = e.__k, a = 0; o && a < o.length; a++)(r = o[a]) && (r.__ = e, t = "function" == typeof r.type ? yn(r, t, n) : kn(n, r, r, o, r.__e, t));
        return t
    }
    ...
    function Cn(e, t, n, r, o) {
        ...
        else if ("o" === t[0] && "n" === t[1]) a = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + a] = n, n ? r || e.addEventListener(t, a ? xn : On, a) : e.removeEventListener(t, a ? xn : On, a);
    ...
    function Nn(e, t, n, r, o, a, i, s, c) {
        ...
        try {
            e: if ("function" == typeof S) {
                ...
                if (u.context = v, u.props = h, u.__P = e, y = Qt.__r, b = 0, "prototype" in S && S.prototype.render) {
                ...
                u.state = u.__s, null != u.getChildContext && (r = ln(ln({}, r), u.getChildContext())), f || null == u.getSnapshotBeforeUpdate || (_ = u.getSnapshotBeforeUpdate(d, g)), E = null != l && l.type === gn && null == l.key ? l.props.children : l, wn(e, Array.isArray(E) ? E : [E], t, n, r, o, a, i, s, c), u.base = t.__e, t.__h = null, u.__h.length && i.push(u), p && (u.__E = u.__ = null), u.__e = !1
            } else null == a && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = Tn(n.__e, t, n, r, o, a, i, c);
            (l = Qt.diffed) && l(t)
        }
        catch (e) {
    ...
    function Tn(e, t, n, r, o, a, i, s) {
        ...
        if (null === g) f === d || s && e.data === d || (e.data = d);
            ...
            if (a = a && Zt.call(e.childNodes), l = (f = n.props || an).dangerouslySetInnerHTML, u = d.dangerouslySetInnerHTML, !s) {
                if (null != a)
            ...
            if (function(e, t, n, r, o) {
                    ...
                    for (a in t) o && "function" != typeof t[a] || "children" === a || "key" === a || "value" === a || "checked" === a || n[a] === t[a] || Cn(e, a, t[a], n[a], r)
                }(e, d, f, o, s), u) t.__k = [];
            else if (_ = t.props.children, wn(e, Array.isArray(_) ? _ : [_], t, n, r, o && "foreignObject" !== g, a, i, a ? a[0] : n.__k && pn(n, 0), s), null != a)
                for (_ = a.length; _--;) null != a[_] && un(a[_]);
            s || ("value" in d && void 0 !== (_ = d.value) && (_ !== e.value || "progress" === g && !_ || "option" === g && _ !== f.value) && Cn(e, "value", _, f.value, !1), "checked" in d && void 0 !== (_ = d.checked) && _ !== e.checked && Cn(e, "checked", _, f.checked, !1))
        }
        return e
    }
    ...
    function An(e, t, n) {
        var r, o;
        if (Qt.unmount && Qt.unmount(e), (r = e.ref) && (r.current && r.current !== e.__e || jn(r, null, t)), null != (r = e.__c)) {
    ...
    Zt = sn.slice, Qt = {
        ...
        var n;
        n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = ln({}, this.state), "function" == typeof e && (e = e(ln({}, n), this.props)), e && ln(n, e), null != e && this.__v && (t && this._sb.push(t), mn(this))
    }, _n.prototype.forceUpdate = function(e) {
        this.__v && (this.__e = !0, e && this.__h.push(e), mn(this))
    }, _n.prototype.render = gn, tn = [], rn = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, on = function(e, t) {
        return e.__v.__b - t.__v.__b
    }, vn.__r = 0;
    var Dn, Rn, In, Wn, Un = 0,
        Mn = [],
        qn = [],
        Hn = Qt.__b,
        zn = Qt.__r,
    ...
    function Gn(e) {
        return Un = 1,
            function(e, t, n) {
                var r = $n(Dn++, 2);
                if (r.t = e, !r.__c && (r.__ = [n ? n(t) : nr(void 0, t), function(e) {
    ...
    Qt.__b = function(e) {
        ...
        zn && zn(e), Dn = 0;
        var t = (Rn = e.__c).__H;
        t && (In === Rn ? (t.__h = [], Rn.__h = [], t.__.forEach((function(e) {
            e.__N && (e.__ = e.__N), e.__V = qn, e.__N = e.i = void 0
        }))) : (t.__h.forEach(Qn), t.__h.forEach(er), t.__h = [])), In = Rn
    }, Qt.diffed = function(e) {
        Bn && Bn(e);
        var t = e.__c;
        t && t.__H && (t.__H.__h.length && (1 !== Mn.push(t) && Wn === Qt.requestAnimationFrame || ((Wn = Qt.requestAnimationFrame) || Zn)(Kn)), t.__H.__.forEach((function(e) {
            e.i && (e.__H = e.i), e.__V !== qn && (e.__ = e.__V), e.i = void 0, e.__V = qn
        }))), In = Rn = null
    }, Qt.__c = function(e, t) {
        t.some((function(e) {
            try {
                e.__h.forEach(Qn), e.__h = e.__h.filter((function(e) {
                    return !e.__ || er(e)
                }))
            } catch (n) {
                t.some((function(e) {
    ...
    function or(e) {
        this.props = e
    }(or.prototype = new _n).isPureReactComponent = !0, or.prototype.shouldComponentUpdate = function(e, t) {
    ...
    var _r = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103,
        pr = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,
    ...
    Qt.event = function(e) {
        return yr && (e = yr(e)), e.persist = br, e.isPropagationStopped = kr, e.isDefaultPrevented = Er, e.nativeEvent = e
    };
    var Sr = {
            enumerable: !1,
            configurable: !0,
    ...
    Qt.vnode = function(e) {
        "string" == typeof e.type && function(e) {
            ...
            for (var o in t) {
                var a = t[o];
                if (!("value" === o && "defaultValue" in t && null == a || vr && "children" === o && "noscript" === n || "class" === o || "className" === o)) {
                    var i = o.toLowerCase();
                    "defaultValue" === o && "value" in t && null == t.value ? o = "value" : "download" === o && !0 === a ? a = "" : "ondoubleclick" === i ? o = "ondblclick" : "onchange" !== i || "input" !== n && "textarea" !== n || wr(t.type) ? "onfocus" === i ? o = "onfocusin" : "onblur" === i ? o = "onfocusout" : hr.test(o) ? o = i : -1 === n.indexOf("-") && pr.test(o) ? o = o.replace(mr, "-$&").toLowerCase() : null === a && (a = void 0) : i = o = "oninput", "oninput" === i && r[o = i] && (o = "oninputCapture"), r[o] = a
                }
            }
            ...
            }))), t.class && !t.className ? (r.class = t.class, Object.defineProperty(r, "className", Sr)) : (t.className && !t.class || t.class && t.className) && (r.class = r.className = t.className), e.props = r
        }(e), e.$$typeof = _r, Cr && Cr(e)
    };
    var Or = Qt.__r;
    Qt.__r = function(e) {
        Or && Or(e), e.__c
    ...
    function Lr(e) {
        var t = function(e) {
                return void 0 === e && (e = "default"), Nr.find((function(t) {
    ...
    function jr(e) {
        ...
        return n && n.custom_local_name ? n.custom_local_name : n && n.custom_name ? n.custom_name : t === gt.language_from && gt.language_from_custom_name ? gt.language_from_custom_name : Tr[t].name
    }
    ...
    function Dr(e, t) {
        return "WordPress" === gt.technology_name && gt.injectedData && !gt.is_connect ? t(gt.injectedData.switcher_links[e]) : Xe(e, t)
    }
    var Rr = 13,
        Ir = 27,
        Wr = 38,
    ...
    function Hr() {
        var e = Gn("WordPress" === gt.technology_name && gt.injectedData && !gt.is_connect ? gt.injectedData.current_language : gt.switcher_editor ? gt.language_from : window.Weglot.getCurrentLang()),
            t = e[0],
            n = e[1];
        return Jn((function() {
            gt.is_connect || "WordPress" === gt.technology_name || gt.switcher_editor || window.Weglot.on("languageChanged", (function(e) {
                n(e)
            }))
        }), []), [t, n]
    }
    ...
    function Br(e) {
        ...
        function S(e) {
            ...
            var t;
            a(e), t = e, "WordPress" === gt.technology_name && gt.injectedData && !gt.is_connect ? Dr(t, (function(e) {
        ...
        return Jn((function() {
            ...
            handleKeyDown: function(e) {
                return e.keyCode === Rr ? (e.preventDefault(), g && S(g), E()) : e.keyCode === Ur || e.keyCode === Wr ? (e.preventDefault(), void
                    function(e) {
                        var t = e === Ur ? "down" : "up",
                            n = f.slice(-1).pop(),
                            r = f[0],
                        ...
                        _(f[c])
                    }(e.keyCode)) : void(e.keyCode === Ir && s && (e.preventDefault(), E()))
            },
            switchLanguage: S,
            toggleOpen: E
        }
    ...
    var Fr, Vr, $r, Gr = {
        ...
        Kr = function(e, t) {
            return function(n) {
                ...
                return function(e, t, n) {
                    var r, o, a;
                    Qt.__ && Qt.__(e, t), o = (r = "function" == typeof n) ? null : n && n.__k || t.__k, a = [], Nn(t, e = (!r && n || t).__k = fn(gn, null, [e]), o || an, an, void 0 !== t.ownerSVGElement, !r && n ? [n] : o ? null : t.firstChild ? Zt.call(t.childNodes) : null, a, !r && n ? n : o ? o.__e : t.firstChild, r), Ln(a, e)
                }(fn(e, {
            ...
            var t = e.style,
                ...
                b = /background-position/i.test(gt.button_style.custom_css) && !gt.languages.some((function(e) {
    ...
    function Qr(e, t) {
        if (void 0 === t && (t = document.documentElement), e && !e.ready) {
            ...
            var o = function(e, t) {
                    ...
                    var o = ce(t, n);
                    if (!o.length) return {
                        error: me(n) ? "The provided target is not on this page." : "The provided target is not a valid CSS selector."
                    };
                    var a = ce(t, r);
                ...
                c = o.defaultPosition;
            if (!a) {
                var l = Kr(Object.assign({}, e, !gt.switcher_editor && {
                    style: n
                }));
                if (l.weglotSwitcher = e, Zr.push(l), c) return l.classList.add("wg-default"), document.body.appendChild(l), e.ready = !0, l;
                l.setAttribute("data-switcher-id", String(++Xr)), l.id = "weglot-switcher-" + Xr, l.setAttribute("data-switcher-style-opt", JSON.stringify(n)), i.insertBefore(l, s), e.ready = !0;
        ...
        if (void 0 === e && (e = document), !(Et().length < 2 || gt.hide_switcher)) {
            ...
            (function(e) {
                if (void 0 === e && (e = document.body), 0 !== ce(e, 'a[href^="#Weglot-"],a[href*="change-language.weglot.com/"]').length) {
                    for (var t = Et(), n = Ue(), r = !1, o = [], a = function() {
                            var t = s[i],
                                a = ce(e, Xt(t));
                            if (0 !== a.length) {
                                r = !0;
                                for (var c = function() {
                                        var e = u[l];
                                        e.setAttribute(z, ""), e.classList.add("weglot-link", "weglot-link-" + t), t === n && e.classList.add("weglot-link--active"), Xe(t, (function(t) {
                                            return e.setAttribute("href", t)
    ...
    Ne("onCurrentLocationChanged", (function() {
        ...
        })), Zr.splice(0), window.Weglot.switchers && Object.values(window.Weglot.switchers).forEach((function(e) {
            e.removeSwitchers()
        })), Fr = null, Vr = null, Xr = 0, gt.button_style.ready = !1, gt.switchers.map((function(e) {
            return e.ready = !1
        })), no()
    }), !0);
    var ro = 0;
    ...
    function oo() {
        ...
        gt.translate_event.forEach((function(t) {
            for (var n = ce(document.body, t.selector), r = function() {
                    var n = a[o];
                    if (n.alreadyListeningEventInput) return !n.alreadyListeningEventInput.isConnected && ro < 10 && (ro++, n.parentNode.insertBefore(n.alreadyListeningEventInput, n.nextSibling)), {};
                    var r = n.cloneNode(!0);
                    if (!r) return {};
    ...
    function io(e) {
        if (gt.translate_shadow_roots) {
            e || (e = ce(document, gt.dynamics.map((function(e) {
                return e.value
            })).join(",")));
    ...
    function _o(e, t) {
        ...
        lo.length && (so = setTimeout((function() {
            no(e), oo(), gt.subdomain && function(e) {
            ...
            }(lo), io(lo), Ee("onDynamicDetected"), lo = []
        }), 100))
    }
                    ...
                    var n = [],
                        r = e.filter((function(e) {
                            ...
                            return i ? (n.push(i), !1) : r.length ? (setTimeout((function() {
                                return _o(a, r)
                            })), !co || !a || !ue(a, co)) : !uo.includes(e.attributeName) && t(a) && ("characterData" === o || "attributes" === o)
                        }));
                    if (n.length)
                    ...
                    for (var r = [], o = function(e) {
                            ...
                            if (e.wgParsed !== n) {
                                ...
                                for (var o = Ht(e, (function(e) {
                                    ...
                                    var s = i[a];
                                    gt.ignoreDynamicFragments && !document.body.contains(s) || (s.weglot.dynamic || (s.weglot.dynamic = 0), s.weglot.dynamic++, r.push(s))
                                }
                            }
                        ...
                        switch (l) {
                            ...
                            case "childList":
                                ...
                                for (var g = 0, _ = f; g < _.length; g += 1) {
                                    var h = _[g],
                                        m = [];
                                    "IFRAME" === h.tagName ? m = [h] : h.querySelectorAll && (m = h.querySelectorAll("iframe"));
        ...
        var t = e !== document ? e : e.body || e,
            n = new MutationObserver((function(t) {
                ...
                if (ho) po(t, e);
                    ...
                    r ? (n = r.mutations).push.apply(n, t) : fo.push({
                        documentElement: e,
                        mutations: [].concat(t)
                    })
                }
    ...
    function vo(e) {
        return !(!gt.dynamics || 0 === gt.dynamics.length) && (e && e.closest || (e = e.parentNode), e && e.closest && ue(e, gt.dynamics.map((function(e) {
            return e.value
        })).join(", ")))
    }
    var wo = {
    ...
    function yo(e) {
        ...
        if (t !== gt.language_from) {
            if (wo.times = wo.times.filter((function(e) {
                    return e > Date.now() - 1e3
                })), wo.times.length && (wo.timeout || wo.times.length >= 10)) return wo.nodes = wo.nodes.concat(e), void(wo.timeout = setTimeout((function() {
                return yo()
            }), 1e3));
            wo.timeout = null, wo.times.push(Date.now());
            var n = wo.nodes.concat(e);
            return wo.nodes = [], Yt(Ft(n), t, {
                title: !1,
                cdn: !0,
                nodes: n
            }).then((function(e) {
    ...
    function To(e, t, n) {
        if (n || !e || window.top !== window || !Po(e)) {
            ...
            var o = kt();
            if (e && t && !o && Tt(e), !gt.is_connect || gt.dynamicPushState || !o && e !== gt.language_from ? function(e) {
                    void 0 === e && (e = !0);
                ...
                for (var a = [], i = 0, s = r; i < s.length; i += 1) {
                    var c = s[i];
                    (c.closest && c.closest(gt.force_translation) || !c.closest && c.parentNode && c.parentNode.closest && c.parentNode.closest(gt.force_translation)) && a.push(c)
                }
                yo(a)
            }
            o && !o.language_button_displayed && o.allExcluded || no(), o || (gt.remove_unused_link_hooks && function() {
                var e = Et(),
                    t = gt.languages.map((function(e) {
                        return e.custom_code || e.language_to
                    })).filter((function(t) {
                        return !e.includes(t)
                    }));
                ...
                ke("onPageLanguageSet", No), "with-window-top" === Lo() && window.top.postMessage({
                ...
                window[e] = function() {
                    ...
                    if ("string" == typeof arguments[0]) {
                        var n = Ue();
                        return gt.language_from === n ? t.apply(window, arguments) : Yt([{
                            t: 2,
                            w: arguments[0]
                        }], n, {
                            title: !1,
    ...
    function jo(e) {
        var t = Ue();
        e !== t && (gt.visual_editor ? Xe(e, (function(n) {
            if ("#" === n) return Ao(e, t);
    ...
    function Ao(e, t) {
        if (!Et().includes(e)) return jt(), void W.warn(e + " isn't a language you have added", {
            sendToDatadog: !1
        });
        gt.auto_switch && xt(e);
        var n = kt();
        if (gt.is_connect || n || Tt(e), !Po(e)) {
            if (gt.loading_bar) var r = function() {
                try {
                    var e = document.createElement("div");
                    return e.className = "wg-progress", e.id = "wg_progress", e.innerHTML = '<div class="wg-progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0"></div>', document.body.appendChild(e), setInterval(bo, 100)
                } catch (e) {}
            }();
            if (function(e) {
                    var t = _e("lang");
                    ...
                    Ae = e
                }(e), kt()) return jt(), void ko(r);
            if (e === gt.language_from) return Ee("onPageLanguageSet", e), jt(), Vt(null, e), gt.loading_bar && ko(r), document.documentElement.setAttribute("lang", e), void Le("languageChanged", e, t || "");
            Yt(Ft(), e).then((function(n) {
                jt(), Vt(n, e), document.documentElement.setAttribute("lang", e), Le("languageChanged", e, t || ""), gt.loading_bar && ko(r)
            })).catch((function(e) {
    ...
    function Po(e) {
        return !(!gt.is_connect || Ue() === e) && (!gt.host || gt.previewHash && window.location.hostname.includes(M) || function() {
            if (gt.subdirectory) return [gt.host, B];
            return gt.languages.map((function(e) {
                return e.connect_host_destination && e.connect_host_destination.host
            })).concat([gt.host, B])
        }().includes(window.location.hostname) ? (Xe(e, (function(e) {
            return window.location.replace(e)
        })), !0) : (Lo() || W.warn('"' + window.location.hostname + '" is not configured with Weglot. Please contact support@weglot.com', {
            sendToDatadog: !1
        }), !1))
    }
    Ne("initialized", (function() {
        gt.translate_search && !gt.switcher_editor && function() {
            for (var e = gt.search_forms, t = gt.search_parameter, n = 0, r = ce(document, e); n < r.length; n += 1) {
                var o = r[n];
    ...
    function Io() {
        if (gt.api_key) {
            Ne("initialized", (function() {
                gt.page_views_enabled && (gt.is_connect ? Xe(gt.language_from, (function(e) {
                    return Nt(e)
                })) : Nt())
            }), !0);
            try {
            ...
            if (Ee("onWeglotSetup"), !Ho.initialized || window.Turbolinks) {
                ...
                var e = kt();
                if ((Co = So && So !== gt.language_from && document.documentElement.dataset.wgTranslated !== So && !e && !document.documentElement.dataset.wgExcludedUrl && !gt.switcher_editor) && gt.wait_transition ? pe("@keyframes wg{from{color:transparent;}to{color:transparent;}}body *{color:transparent!important;animation:1s linear infinite wg!important;}", H) : jt(), gt.delayStart) return Ne("start", (function() {
                    return Wo()
                }), !0);
    ...
    var Mo = [/cdn(?:-staging)?\.weglot\.(?:com|us)\/weglot\.min\.js\?(?<params>[^#]+)/, /cdn(?:-staging)?\.weglot\.(?:com|us)\/weglot-switcher-editor\.js\?(?<params>[^#]+)/, /cdn(?:-staging)?\/.\/weglot\.(?:com|us)\/weglot_squarespace-[0-9]+\.min\.js\?(?<params>[^#]+)/];

    function qo(e) {
        return e && e.src ? Mo.find((function(t) {
            return t.test(e.src)
        })) : null
    }
    var Ho = window.Weglot || {
        ...
        switchTo: jo,
        setup: function(e) {
            Ro(), Eo || (Eo = !0, xe(mt(), "polyfillReady", (function() {
                ut(e).then((function() {
                    return Io()
                })).catch((function() {
        ...
        translate: function(e, t) {
            ...
            return r === gt.language_from ? (t && t(n.map((function(e) {
                return e.w
    ...
    return xe(mt(), "polyfillReady", (function() {
        mo(document);
        var e = function(e) {
            var t = qo(e);
            if (!t) return null;
