...
_hsp.push(['addCookieDomain', '.backuphunt.com']);
_hsp.push(['addCookieDomain', '.hsforms.com']);
_hsp.push(['addCookieDomain', '.qubit9.com']);
...
! function(t) {
    ...
    n.p = "//static.hsappstatic.net/cookie-banner-js/static-1.938/";
    n(n.s = 3)
}([function(t, e, n) {
    var o;
    ...
    O.TOP = new O(0, "");
    O.BOTTOM = new O(1, "hs-cookie-notification-position-bottom");
    class I {
        constructor(t, e, n) {
            this.position = t;
            this.accentColor = e;
    ...
    const B = new P.a({
        ...
        D = t => {
            ...
            try {
                ...
                T.error("we had an error sanitizing an html string: " + t)
            }
            return e.innerHTML
        },
        R = t => ({
    ...
    class M {
        ...
        static fromJS(t) {
            return new M(t.notification, t.acceptLabel, t.declineLabel, t.disclaimer, t.modalText && t.modalText.cookieSettingsLabel, t.modalText && H.fromJS(t.modalText))
        }
        getSanitizedText() {
            return new M(D(this.notification), D(this.acceptLabel), D(this.declineLabel), D(this.disclaimer), this.cookieSettingsLabel && D(this.cookieSettingsLabel), this.modalText && this.modalText.getSanitizedText())
        }
    }
    class z {
        constructor(t, e) {
    ...
    z.COOKIES_WITHOUT_BANNER = new z(0, "COOKIES_WITHOUT_BANNER");
    z.NO_COOKIES = new z(1, "NO_COOKIES");
    z.NOTIFY = new z(2, "NOTIFY");
    z.OPT_IN = new z(3, "OPT_IN");
    z.COOKIES_BY_CATEGORY = new z(4, "COOKIES_BY_CATEGORY");
    class U {
        constructor(t, e) {
            this.type = t;
            this.text = e
        ...
        static fromJS(t) {
            ...
            return new U(z.fromJS(e), M.fromJS(n))
        }
        getSanitizedPolicy() {
    ...
    class Y {
        ...
        static fromJS(t) {
            ...
            return new Y(e, n, o, i, s, A.fromJS(a), U.fromJS(r), I.fromJS(c), F.fromJS(l))
        }
        withSanitizedPolicy() {
        ...
        toLegacyPrivacyPolicy() {
            ...
            return {
                ...
                hideDecline: this.policy.type === z.NOTIFY,
    ...
    class $ {
        ...
        toCookieString() {
            return `${W}:${this.categories.analytics},${K}:${this.categories.advertisement},${q}:${this.categories.functionality}`
        }
    ...
    function vt() {
        for (var t; vt.__r = st.length;) t = st.sort((function(t, e) {
            ...
            var e, n, o, i, s, a;
            t.__d && (s = (i = (e = t).__v).__e, (a = e.__P) && (n = [], (o = dt({}, i)).__v = i.__v + 1, At(a, i, o, e.__n, void 0 !== a.ownerSVGElement, null != i.__h ? [s] : null, n, null == s ? _t(i) : s, i.__h), Ot(n, i), i.__e != s && bt(i)))
        }))
    }
    ...
    function xt(t, e, n, o, i, s, a, r, c, l) {
        ...
        for (n.__k = [], h = 0; h < e.length; h++)
            if (null != (m = n.__k[h] = null == (m = e[h]) || "boolean" == typeof m ? null : "string" == typeof m || "number" == typeof m || "bigint" == typeof m ? pt(null, m, null, null, m) : Array.isArray(m) ? pt(ft, {
                ...
                At(t, m, u = u || ct, i, s, a, r, c, l), p = m.__e, (d = m.ref) && u.ref != d && (g || (g = []), u.ref && g.push(u.ref, null, m), g.push(d, m.__c || p, m)), null != p ? (null == f && (f = p), "function" == typeof m.type && m.__k === u.__k ? m.__d = c = Ct(m, c, t) : c = kt(t, m, u, _, p, c), "function" == typeof n.type && (n.__d = c)) : c && u.__e == c && c.parentNode != t && (c = _t(u))
            }
    ...
    function wt(t, e, n, o, i) {
        var s;
        for (s in n) "children" === s || "key" === s || s in e || Lt(t, s, null, n[s], o);
        for (s in e) i && "function" != typeof e[s] || "children" === s || "key" === s || "value" === s || "checked" === s || n[s] === e[s] || Lt(t, s, e[s], n[s], o)
    }
    ...
    function Lt(t, e, n, o, i) {
        ...
        else if ("o" === e[0] && "n" === e[1]) s = e !== (e = e.replace(/Capture$/, "")), e = e.toLowerCase() in t ? e.toLowerCase().slice(2) : e.slice(2), t.l || (t.l = {}), t.l[e + s] = n, n ? o || t.addEventListener(e, s ? Et : Tt, s) : t.removeEventListener(e, s ? Et : Tt, s);
    ...
    function It(t, e, n, o, i, s, a, r) {
        ...
        if (null === m) d === u || r && t.data === u || (t.data = u);
            ...
            r || ("value" in u && void 0 !== (p = u.value) && (p !== t.value || "progress" === m && !p || "option" === m && p !== d.value) && Lt(t, "value", p, d.value, !1), "checked" in u && void 0 !== (p = u.checked) && p !== t.checked && Lt(t, "checked", p, d.checked, !1))
        }
        return t
    }
    ...
    function Dt(t, e, n) {
        var o, i, s;
        ot.__ && ot.__(t, e), i = (o = "function" == typeof n) ? null : n && n.__k || e.__k, s = [], At(e, t = (!o && n || e).__k = mt(ft, null, [t]), i || ct, ct, void 0 !== e.ownerSVGElement, !o && n ? [n] : i ? null : e.firstChild ? nt.call(e.childNodes) : null, s, !o && n ? n : i ? i.__e : e.firstChild, o), Ot(s, t)
    }
    nt = lt.slice, ot = {
            __e: function(t, e) {
    ...
    function Zt(t, e) {
        var n = $t(Ht++, 3);
        !ot.__s && ie(n.__H, e) && (n.__ = t, n.__H = e, Mt.__H.__h.push(n))
    }
    ...
    ot.__b = function(t) {
        ...
        Kt && Kt(t);
        var e = t.__c;
        e && e.__H && e.__H.__h.length && (1 !== Ft.push(e) && zt === ot.requestAnimationFrame || ((zt = ot.requestAnimationFrame) || function(t) {
            var e, n = function() {
    ...
    function ne(t) {
        var e = Mt,
            n = t.__c;
        "function" == typeof n && (t.__c = void 0, n()), Mt = e
    }
    ...
    function ce({
        ...
        const m = a ? -1 : 1,
            p = i.policy,
            f = i.policy.type,
            g = f === z.COOKIES_BY_CATEGORY,
            _ = f === z.OPT_IN || f === z.COOKIES_BY_CATEGORY,
    ...
    function ue({
        ...
        const [s, a] = jt(!1), r = t === _.NECESSARY, c = Qt(null), l = Qt(null), h = () => {
            a(!s)
        };
        Zt(() => {
            if (s) {
    ...
    const _e = "#425b76",
        be = (t, e, n, o, i) => {
            ...
            const r = i ? e.replaceAll("https://api_base_url", i) : e,
                c = n ? r.replaceAll(_e, n) : r,
                l = s.createTextNode(c);
            a.appendChild(l);
            const h = s.body.firstChild;
            s.body.insertBefore(a, h)
        };
    ...
    const xe = (t, e, n, o) => {
        ...
        s.setAttribute("id", n);
        const a = o ? e.replaceAll("https://api_base_url", o) : e,
            r = i.createTextNode(a);
        s.appendChild(r);
        const c = i.body.firstChild;
        i.body.insertBefore(s, c)
    };
    ...
    function we({
        ...
        Zt(() => {
            r.current && re(n, r.current, c.current, l.current)
        }, [n, r, c, l]);
        const [d, u] = jt(e.categories.analytics), [m, p] = jt(e.categories.advertisement), [b, y] = jt(e.categories.functionality), v = () => {
            i({
                [_.ANALYTICS]: d,
                [_.ADVERTISEMENT]: m,
                [_.FUNCTIONALITY]: b
    ...
    function Se({
        ...
        const [c, l] = jt(!1), h = () => {
            ...
            if (t !== z.OPT_IN && t !== z.COOKIES_BY_CATEGORY) {
                e.update(!0);
                i(e)
            } else s()
        }, f = () => {
        ...
        a ? Ce(o, a, t) : ye(o, n.customizationSettings.accentColor, t);
        return Gt(ft, {
            children: [Gt(ce, {
                context: o,
                setting: n,
                onAcceptAll: h,
                onDeclineAll: d,
                onCookieSettingsClick: f,
                onCloseBannerButtonClick: p,
                isModalDisplayed: c
            }), c && Gt(we, {
    ...
    function Le({
        ...
        i ? Ce(e, i, t) : ye(e, n.customizationSettings.accentColor, t);
        return Gt("div", {
            id: m,
    ...
    class Oe {
        static postActivity(t, e, n) {
            ...
            }).then(() => T.info(`Sent a banner ${e} event.`)).catch(() => T.error(`There was an issue sending a banner ${e} event.`))
        }
        static sendView(t, e) {
            Oe.postActivity(t + "/activity/view", "VIEW", e)
        }
        static sendClick(t, e) {
            Oe.postActivity(t + "/activity/click", "CLICK", e)
        }
    }
    class Ie {
        constructor(t) {
        ...
        run() {
            if (this.disableBannerFlagSet()) {
                T.info('"PRIVACY" flag found in disabledHsPopups window queue. Banner script will not run.');
                return !0
            }
            this.findMatchingSetting();
            this.logGpcSignal();
            if (!this.matchedSetting) {
                T.debug("we were unable to find the matching settings for this webpages. The banner will not run.");
                this.setConsent(new $(!0), {
                    reportClick: !1
                });
                return !1
            }
                ...
                case z.COOKIES_BY_CATEGORY:
                    {
                        ...
                        this.cookie.removeGACookie();this.setConsent($.buildInitialConsent(), {
                            persist: !1,
                            reportClick: !1
                        });this.renderBanner();
                        break
        ...
        shouldScanningOverride() {
            return [z.COOKIES_BY_CATEGORY, z.OPT_IN, z.NOTIFY].includes(this.matchedSetting.policy.type) && this.context.getWindow()[c]
        }
        shouldGpcOverride() {
        ...
        logGpcSignal() {
            T.debug("GPC signal: " + this.getGpcSignal())
        }
        findMatchingSetting() {
        ...
        setApiBaseUrl(t) {
            /^https:\/\/js-?.{0,3}\.hs-banner(qa)?\.com.*/.test(t) ? this.apiBaseUrl = t : T.error("unsupported base Api url provided.")
        }
        setBannerSettings(t) {
        ...
        getCurrentGeoLocation() {
            return new Promise(t => {
                ...
                if (e.includes(a)) {
                    ...
                    T.error("We could not fetch the geolocation.");
                    t("")
                })
            })
        }
        ...
        setConsentCookie() {
            ...
            t !== z.NO_COOKIES && t !== z.COOKIES_WITHOUT_BANNER && this.cookie.set(et.CATEGORY_PREFERENCE_COOKIE.getName(), this.consent.toCookieString(), {
        ...
        readConsentCookie() {
            ...
            return t ? $.buildFromCookieString(t) : null
        }
        safeCallListener(t, e) {
            try {
                t(e)
            } catch (t) {
                T.error("error calling listener.")
            }
        }
        ...
        renderGpcBanner() {
            this.bannerParentElement = Ae(this.apiBaseUrl, this.context, this.matchedSetting, this.dismissGpcBanner.bind(this));
            this.sendViewActivity()
        }
        renderBanner() {
            this.bannerParentElement = Ee(this.apiBaseUrl, this.consent, this.matchedSetting, this.context, this.setConsent.bind(this), this.hideBanner.bind(this));
            this.sendViewActivity()
        }
        hideBanner() {
        ...
        showBanner() {
            if (this.matchedSetting.policy.type === z.NO_COOKIES || this.matchedSetting.policy.type === z.COOKIES_WITHOUT_BANNER) return;
        ...
        invoke(t, e) {
            if (this.privateMethods.includes(t) || !Reflect.has(this, t)) {
                T.debug(`failed to invoke method ${t} of the banner.`);
        ...
        sendClickActivity() {
            ...
            Oe.sendClick(this.apiBaseUrl, e)
        }
        sendViewActivity() {
            if (!this.matchedSetting || this.isRunningInTestMode) return;
            const t = this.getBaseActivityPayload();
            Oe.sendView(this.apiBaseUrl, t)
        }
        getAnalyticsQueue() {
        ...
        trackAction(t) {
            try {
                ...
                T.error("Unable to send analytics tracking event: " + t)
            }
        }
    ...
    class Ne {
        constructor(t) {
            ...
            this.banner = new Ie(t);
            this.context = t
        }
        queuePushFn(t) {
            try {
                if (!(t && Array.isArray(t) && t.length > 0)) {
                    T.debug("invalid arguments passed to the banner queue.");
                    return !1
                }
                const e = t[0],
                    n = t.slice(1);
                ...
                T.error("There was an error running banner method.")
            }
            return !1
        }
        overrideQueuePush() {
    ...
    function Be() {
        const t = Pe.getWindow();
        if (t[o]) {
            T.info("the cookie banner has already been loaded via another script.");
            return
        }
        t[o] = !0;
        new Ne(Pe).run()
    }
    const De = Pe.getDocument();

    function Re() {
        Be();
        De.removeEventListener("DOMContentLoaded", Re)
    }
    "loading" === De.readyState ? De.addEventListener("DOMContentLoaded", Re) : Be()
}]);
/****** Cookie Banner version static-1.938 *****/