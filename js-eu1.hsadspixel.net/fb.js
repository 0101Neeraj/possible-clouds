! function(e) {
    ...
    var o = [{
        ...
        path: "head-dlb/static-1.368/bundle.production.js",
        ids: {}
    }];
    ...
    t.p = "//static.hsappstatic.net/adsscriptloaderstatic/static-1.396/";
    t(t.s = 0)
}([function(e, n, t) {
    "use strict";
    t.r(n);
    ...
    function p(e, n) {
        ! function(e, n, t, o, a, r, i) {
            if (!e.fbq) {
                ...
                a.agent = "tmhubspot";
                a.queue = [];
                (r = n.createElement(t)).async = !0;
                r.src = o;
                (i = n.getElementsByTagName(t)[0]).parentNode.insertBefore(r, i)
            }
        ...
        x = function() {
            ...
            if (!(window.disabledHsPopups && window.disabledHsPopups.indexOf("ADS") > -1)) {
                ...
                window._hsp.push(["addPrivacyConsentListener", function(e) {
                    e.categories.advertisement ? o ? m(o, a) : _({
                ...
                window.addEventListener("message", e => {
                    let n;
                    if ("hsFormCallback" === e.data.type && "onFormSubmitted" === e.data.eventName) {
                        n = function() {
